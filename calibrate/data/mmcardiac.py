...
class CardiacmmDataset(Dataset):
...
def get_train_val_loader(data_root, batch_size=32, num_workers=8, pin_memory=True):
    ...
    train_dataset = CardiacmmDataset(train_files)
    valid_dataset = CardiacmmDataset(valid_files)
...
def get_test_loader(data_root, batch_size=32, num_workers=8, pin_memory=True):
    ...
    test_dataset = CardiacmmDataset(test_files)
